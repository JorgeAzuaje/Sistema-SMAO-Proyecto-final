...
const {getEquipos, getEquipo, postEquipos, putEquipos, deleteEquipos, getTrabajoEq} = require('../controllers/equipos')
...
router.post('/', authMiddleware, checkRol(["Admin","Tecnico"]), postEquipos);
